...
- [doc/개발환경.md](doc/개발환경.md) 파일을 안티그래비티 채팅창에 드래그 앤 드롭하여 개발 환경 기준을 AI에게 알려줍니다.

### 4️⃣ 구현 요구사항 전달 (Drag & Drop)
- [doc/바이브코딩앱개발샘플/네이버뉴스정리앱.md](doc/바이브코딩앱개발샘플/네이버뉴스정리앱.md) 파일을 채팅창에 드래그 앤 드롭하여 구현할 기능 요건을 전달합니다.

- [doc/바이브코딩앱개발샘플/반려견캐어앱.md](doc/바이브코딩앱개발샘플/반려견캐어앱.md) 파일을 채팅창에 드래그 앤 드롭하여 구현할 기능 요건을 전달합니다.
