...
안티그래비티 AI 어시스턴트를 활용해 바이브 코딩(Vibe Coding)을 시작하는 실습 과정입니다. 각 앱별로 아래 단계를 순서대로 진행해 보세요.
...
*   **1️⃣ 작업 폴더 생성**
    *   탐색기(Finder/Explorer)에서 작업할 폴더인 `github.com`을 생성합니다. (이미 존재한다면 생략 가능)
    *   `github.com` 폴더 하위에 **`fezh-vibecoding-naver-news-본인영문이름`** 폴더를 새로 만듭니다.
*   **2️⃣ 안티그래비티 IDE 실행**
    *   메뉴에서 **파일 > 뉴 윈도우(New Window)**를 선택합니다.
    *   새로 만든 **`fezh-vibecoding-naver-news-본인영문이름`** 폴더를 활성화하여 엽니다.
*   **3️⃣ 저장소 클론 (Git Clone)**
    *   채팅창에 다음과 같이 입력하여 템플릿 저장소를 복제합니다.
        ```text
        https://github.com/raymondbae/Practical-Vibe-Coding-Course.git 복사 해줘
        ```
*   **4️⃣ 개발 환경 명세 전달 (Drag & Drop)**
    *   프로젝트 내의 [doc/개발환경.md](doc/개발환경.md) 파일을 안티그래비티 채팅창에 **드래그 앤 드롭**하여 개발 환경 사양을 학습시킵니다.
*   **5️⃣ 구현 요구사항 전달 (Drag & Drop)**
    *   [doc/바이브코딩앱개발샘플/네이버뉴스정리앱.md](doc/바이브코딩앱개발샘플/네이버뉴스정리앱.md) 파일을 채팅창에 **드래그 앤 드롭**하여 구현할 기능 요건을 전달합니다.
*   **6️⃣ 개발 지시 및 실행**
...
*   **1️⃣ 작업 폴더 생성**
    *   탐색기(Finder/Explorer)에서 작업할 폴더인 `github.com`을 생성합니다. (이미 존재한다면 생략 가능)
    *   `github.com` 폴더 하위에 **`fezh-vibecoding-petcare-app-본인영문이름`** 폴더를 새로 만듭니다.
*   **2️⃣ 안티그래비티 IDE 실행**
    *   메뉴에서 **파일 > 뉴 윈도우(New Window)**를 선택합니다.
    *   새로 만든 **`fezh-vibecoding-petcare-app-본인영문이름`** 폴더를 활성화하여 엽니다.
*   **3️⃣ 저장소 클론 (Git Clone)**
    *   채팅창에 다음과 같이 입력하여 템플릿 저장소를 복제합니다.
        ```text
        https://github.com/raymondbae/Practical-Vibe-Coding-Course.git 복사 해줘
...
*   **4️⃣ 개발 환경 명세 전달 (Drag & Drop)**
    *   프로젝트 내의 [doc/개발환경.md](doc/개발환경.md) 파일을 안티그래비티 채팅창에 **드래그 앤 드롭**하여 개발 환경 사양을 학습시킵니다.
*   **5️⃣ 구현 요구사항 전달 (Drag & Drop)**
    *   [doc/바이브코딩앱개발샘플/반려견캐어앱.md](doc/바이브코딩앱개발샘플/반려견캐어앱.md) 파일을 채팅창에 **드래그 앤 드롭**하여 구현할 기능 요건을 전달합니다.
*   **6️⃣ 개발 지시 및 실행**
    *   채팅창에 **`개발해줘`** 또는 **`다 개발 후 실행 해줘`**를 입력하고 전송하면, AI가 요구사항을 분석하여 설계부터 코드 작성, 로컬 실행까지 자동으로 진행합니다.



### 🐶 실습 3. 온라인 광고 부서용 실무 앱 만들기

*   **1️⃣ 작업 폴더 생성**
    *   탐색기(Finder/Explorer)에서 작업할 폴더인 `github.com`을 생성합니다. (이미 존재한다면 생략 가능)
    *   `github.com` 폴더 하위에 **`fezh-vibecoding-adboard-app-본인영문이름`** 폴더를 새로 만듭니다.
*   **2️⃣ 안티그래비티 IDE 실행**
    *   메뉴에서 **파일 > 뉴 윈도우(New Window)**를 선택합니다.
    *   새로 만든 **`fezh-vibecoding-adboard-app-본인영문이름`** 폴더를 활성화하여 엽니다.
*   **3️⃣ 저장소 클론 (Git Clone)**
    *   채팅창에 다음과 같이 입력하여 템플릿 저장소를 복제합니다.
        ```text
        https://github.com/raymondbae/Practical-Vibe-Coding-Course.git 복사 해줘
...
*   **4️⃣ 개발 환경 명세 전달 (Drag & Drop)**
    *   프로젝트 내의 [doc/개발환경.md](doc/개발환경.md) 파일을 안티그래비티 채팅창에 **드래그 앤 드롭**하여 개발 환경 사양을 학습시킵니다.
*   **5️⃣ 구현 요구사항 전달 (Drag & Drop)**
    *   [doc/바이브코딩앱개발샘플/통합광고성과대시보드.md](doc/바이브코딩앱개발샘플/통합광고성과대시보드.md) 파일을 채팅창에 **드래그 앤 드롭**하여 구현할 기능 요건을 전달합니다.
*   **6️⃣ 개발 지시 및 실행**
    *   채팅창에 **`개발해줘`** 또는 **`다 개발 후 실행 해줘`**를 입력하고 전송하면, AI가 요구사항을 분석하여 설계부터 코드 작성, 로컬 실행까지 자동으로 진행합니다.
...
*   **1️⃣ 작업 폴더 생성**
    *   탐색기(Finder/Explorer)에서 작업할 폴더인 `github.com`을 생성합니다. (이미 존재한다면 생략 가능)
    *   `github.com` 폴더 하위에 **`fezh-vibecoding-app-minapaul`** 폴더를 새로 만듭니다.
*   **2️⃣ 안티그래비티 IDE 실행**
    *   메뉴에서 **파일 > 뉴 윈도우(New Window)**를 선택합니다.
    *   새로 만든 **`fezh-vibecoding-app-minapaul`** 폴더를 활성화하여 엽니다.
*   **3️⃣ 저장소 클론 (Git Clone)**
    *   채팅창에 다음과 같이 입력하여 템플릿 저장소를 복제합니다.
        ```text
        https://github.com/raymondbae/Practical-Vibe-Coding-Course.git 복사 해줘
...
*   **4️⃣ 개발 환경 명세 전달 (Drag & Drop)**
    *   프로젝트 내의 [doc/개발환경.md](doc/개발환경.md) 파일을 안티그래비티 채팅창에 **드래그 앤 드롭**하여 개발 환경 사양을 학습시킵니다.
*   **5️⃣ 구현 요구사항 전달 (Drag & Drop)**
    *   [doc/바이브코딩앱개발샘플/미나앤폴홍보사이트.md](doc/바이브코딩앱개발샘플/미나앤폴홍보사이트.md) 파일을 채팅창에 **드래그 앤 드롭**하여 구현할 기능 요건을 전달합니다.
*   **6️⃣ 개발 지시 및 실행**
    *   채팅창에 **`개발해줘`** 또는 **`다 개발 후 실행 해줘`**를 입력하고 전송하면, AI가 요구사항을 분석하여 설계부터 코드 작성, 로컬 실행까지 자동으로 진행합니다.

---

### 📊 실습 5. 유튜브 트렌드 대시보드 만들기

*   **1️⃣ 작업 폴더 생성**
    *   탐색기(Finder/Explorer)에서 작업할 폴더인 `github.com`을 생성합니다. (이미 존재한다면 생략 가능)
    *   `github.com` 폴더 하위에 **`fezh-vibecoding-youtube-trend-본인영문이름`** 폴더를 새로 만듭니다.
*   **2️⃣ 안티그래비티 IDE 실행**
    *   메뉴에서 **파일 > 뉴 윈도우(New Window)**를 선택합니다.
    *   새로 만든 **`fezh-vibecoding-youtube-trend-본인영문이름`** 폴더를 활성화하여 엽니다.
*   **3️⃣ 저장소 클론 (Git Clone)**
    *   채팅창에 다음과 같이 입력하여 템플릿 저장소를 복제합니다.
        ```text
        https://github.com/raymondbae/Practical-Vibe-Coding-Course.git 복사 해줘
...
*   **4️⃣ 개발 환경 명세 전달 (Drag & Drop)**
    *   프로젝트 내의 [doc/개발환경.md](doc/개발환경.md) 파일을 안티그래비티 채팅창에 **드래그 앤 드롭**하여 개발 환경 사양을 학습시킵니다.
*   **5️⃣ 구현 요구사항 전달 (Drag & Drop)**
    *   [doc/바이브코딩앱개발샘플/유튜브트랜드.md](doc/바이브코딩앱개발샘플/유튜브트랜드.md) 파일을 채팅창에 **드래그 앤 드롭**하여 구현할 기능 요건을 전달합니다.
*   **6️⃣ 개발 지시 및 실행**
    *   채팅창에 **`개발해줘`** 또는 **`다 개발 후 실행 해줘`**를 입력하고 전송하면, AI가 요구사항을 분석하여 설계부터 코드 작성, 로컬 실행까지 자동으로 진행합니다.

---

### 🔮 실습 6. 별자리 & MBTI 궁합 사이트 만들기

*   **1️⃣ 작업 폴더 생성**
    *   탐색기(Finder/Explorer)에서 작업할 폴더인 `github.com`을 생성합니다. (이미 존재한다면 생략 가능)
    *   `github.com` 폴더 하위에 **`fezh-vibecoding-nbti-본인영문이름`** 폴더를 새로 만듭니다.
*   **2️⃣ 안티그래비티 IDE 실행**
    *   메뉴에서 **파일 > 뉴 윈도우(New Window)**를 선택합니다.
    *   새로 만든 **`fezh-vibecoding-nbti-본인영문이름`** 폴더를 활성화하여 엽니다.
*   **3️⃣ 저장소 클론 (Git Clone)**
    *   채팅창에 다음과 같이 입력하여 템플릿 저장소를 복제합니다.
        ```text
        https://github.com/raymondbae/Practical-Vibe-Coding-Course.git 복사 해줘
...
*   **4️⃣ 개발 환경 명세 전달 (Drag & Drop)**
    *   프로젝트 내의 [doc/개발환경.md](doc/개발환경.md) 파일을 안티그래비티 채팅창에 **드래그 앤 드롭**하여 개발 환경 사양을 학습시킵니다.
*   **5️⃣ 구현 요구사항 전달 (Drag & Drop)**
    *   [doc/바이브코딩앱개발샘플/별자리-NBTI-궁합.md](doc/바이브코딩앱개발샘플/별자리-NBTI-궁합.md) 파일을 채팅창에 **드래그 앤 드롭**하여 구현할 기능 요건을 전달합니다.
*   **6️⃣ 개발 지시 및 실행**
    *   채팅창에 **`개발해줘`** 또는 **`다 개발 후 실행 해줘`**를 입력하고 전송하면, AI가 요구사항을 분석하여 설계부터 코드 작성, 로컬 실행까지 자동으로 진행합니다.
