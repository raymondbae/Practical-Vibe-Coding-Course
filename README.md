...
## 🚀 4. 바이브 코딩 실습 가이드 (Vibe Coding Quick Start)

안티그래비티 AI 어시스턴트를 활용해 바이브 코딩(Vibe Coding)을 시작하는 실습 과정입니다. 아래 순서대로 단계를 진행해 보세요.

### 1️⃣ 안티그래비티 실행
- 사용 중인 개발 환경(IDE)에서 **Antigravity AI Assistant** 패널을 엽니다.

### 2️⃣ 저장소 클론 (Git Clone)
- 터미널에서 아래 명령어를 실행해 실습 프로젝트 저장소를 로컬에 복제합니다.
  ```bash
  git clone https://github.com/raymondbae/Practical-Vibe-Coding-Course.git myfirst-vibe-coding
  ```

### 3️⃣ 개발 환경 명세 전달 (Drag & Drop)
- [doc/개발환경.md](file:///Users/bjhhmc/github.com/Practical-Vibe-Coding-Course/doc/개발환경.md) 파일을 안티그래비티 채팅창에 드래그 앤 드롭하여 개발 환경 기준을 AI에게 알려줍니다.

### 4️⃣ 구현 요구사항 전달 (Drag & Drop)
- [doc/바이브코딩앱개발샘플/네이버뉴스정리앱.md](file:///Users/bjhhmc/github.com/Practical-Vibe-Coding-Course/doc/바이브코딩앱개발샘플/네이버뉴스정리앱.md) 파일을 채팅창에 드래그 앤 드롭하여 구현할 기능 요건을 전달합니다.

### 5️⃣ 개발 지시 및 실행
- 채팅창에 **`개발해줘`** 또는 **`다 개발 후 실행 해줘`**를 입력하고 전송하면, AI가 요구사항을 분석하여 설계부터 코드 작성, 로컬 실행까지 자동으로 진행합니다.
