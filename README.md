...
- 터미널을 열고 본 실습 프로젝트 저장소를 로컬 컴퓨터로 클론합니다.
  ```bash
  git clone https://github.com/raymondbae/Practical-Vibe-Coding-Course.git
  ```
...
### 5️⃣ 개발 지시 및 실행
- 안티그래비티 채팅창에 **`개발해줘`**를 입력하고 엔터(Enter)를 누르면, AI가 요구사항을 분석하여 설계 및 자동 개발 작업을 주도적으로 시작합니다.
