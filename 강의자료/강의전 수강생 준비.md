...
본 강의는 인공지능 기반의 코드 생성 및 협업 도구를 활용하는 실습 중심의 과정입니다. 원활한 실습 진행을 위해 **강의 시작 전**까지 아래의 준비 사항을 미리 준비해 주시면 , 개발 환경 세팅에 소요되는 시간을 절약하여  본 강의의 핵심 내용에 집중할 수 있습니다.
...
![alt text](SCR-20260521-lszv.png)
![alt text](SCR-20260521-ltfp.png)
![alt text](SCR-20260521-ltmd.png)
![alt text](SCR-20260521-ltzk.png)
![alt text](SCR-20260521-luja.png)
* 본인의 GitHub 이름 과 가입시 이메일 주소를 꼭 적어 두세요!!!!!
![alt text](SCR-20260521-lvjl.png)
...
![alt text](SCR-20260521-lxof.png)
![alt text](SCR-20260521-lxtz.png)
![alt text](SCR-20260521-lyaf.png)
...
- 설치 완료 후 터미널에서 다음 명령어로 버전을 확인하여 설치 상태를 검증합니다.
  ...
  npm -v
  ```
![alt text](SCR-20260521-lyom.png)
...
![alt text](SCR-20260521-majv.png)
![alt text](SCR-20260521-maoy.png)
![alt text](SCR-20260521-mavr.png)
![alt text](SCR-20260521-mbbv.png)

### 2) Turso CLI 설치 (OS별 안내)

#### 🖥️ Windows (윈도우) 사용자
1. PowerShell을 **관리자 권한**으로 실행합니다. (시작 메뉴에서 PowerShell 우클릭 후 '관리자로 실행' 클릭)
![alt text](SCR-20260521-mcjx.png)
2. 아래 명령어를 복사하여 붙여넣고 실행합니다.
   ...
   ```powershell
   $env:Path = "C:\Users\bjhhm\.turso;$env:Path"
   ```
![alt text](SCR-20260521-mfgt.png)
...
![alt text](SCR-20260521-mtxa.png)
![alt text](SCR-20260521-mubx.png)
![alt text](SCR-20260521-muhe.png)
![alt text](SCR-20260521-mupk.png)
![alt text](SCR-20260521-mvbo.png)
![alt text](SCR-20260521-mvlo.png)
---
