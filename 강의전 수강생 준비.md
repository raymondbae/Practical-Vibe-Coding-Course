...
### [설치 및 실행 단계]
1. 강사진이 제공한 **Antigravity 설치 프로그램(또는 익스텐션/바이너리)**을 다운로드합니다.
2. 개발 환경(VS Code 등)에 맞춰 안내에 따라 Antigravity 모듈을 설정해 주세요.
3. 설정 완료 후, 터미널에서 설치 명령어가 올바르게 연동되었는지 확인합니다.
<!-- 구체적인 Antigravity 바이너리/도구의 구동 방식에 맞춰 추후 내용이 추가되거나 변동될 수 있습니다. -->
...
- **[GitHub 공식 웹사이트](https://github.com/)**에 접속하여 회원가입을 완료해 주세요. (가입 후 이메일 인증까지 완료하는 것을 권장합니다.)
